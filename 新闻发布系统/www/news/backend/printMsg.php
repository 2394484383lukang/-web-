...
function printText($msg="添加成功!",$url="index.php",$tg="window"){
	$txt = "<!DOCTYPE html>
<html lang='en'>
<head>
	<meta charset='UTF-8'>
	...
	<style>
		*{margin:0;padding:0;}
		...
		.box{width:300px;height:auto;border:1px solid #ccc;margin:100px auto;padding:10px;}
...
<body>
	<div class='box'>
		<h3>信息提示：</h3>
		<div>{$msg}<span id='time'>3</span>秒后跳转!<a href='$url' target='$tg'>点击跳转</a></div>
	</div>
	<script>

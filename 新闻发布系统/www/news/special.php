...
<body style="padding:5px;background-color:#369;">
	<ol class="breadcrumb" style="background-color:#369;border:1px solid #fff;">
	  ...
	  <li class="active" style="color:#ddd">专题新闻添加</li>
	</ol>


	<div class="panel panel-default">
	  <div class="panel-heading" style="background-color:#369;color:#fff;">
	    <h3 class="panel-title">专题添加新闻:</h3>
	  </div>
	  <div class="panel-body">
	  	
		<form method="post" enctype="multipart/form-data" name="example" action="sRec.php">
		  ...
		  <div class="form-group">
		    <label for="path">专题图片</label>
		    <input type="file" class="form-control" id="path" name="path" placeholder="请选择专题图片" >
		  </div>
